...
main() {
    ...
    echo ""
    echo "Next steps:"
    echo "1. READ FIRST: https://github.com/shandley/claude-for-bioinformatics/blob/master/claude-code-best-practices.md"
    echo "2. Restart your shell or run: source ~/.bashrc"
    echo "3. Create your first project: claude-bio new rnaseq my-analysis"
    echo "4. Start Claude Code: cd my-analysis && claude"
    echo ""
    echo "The bioinformatics context will be automatically loaded!"
    echo ""
